...
```text
FINAL=PASS security_scan_evidence scan_id=fb223a4_20260628182340 worklist_rows=196 completion_receipts=196 candidate_findings=23 validation_receipts=23 attack_path_receipts=23 report_uri=https://...
